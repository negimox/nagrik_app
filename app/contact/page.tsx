      ...
      <main className="flex-1 bg-[#F5F7FA] py-12">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="mb-8 text-center">
            <h1 className="text-3xl font-bold text-[#003A70] mb-4">Contact Us</h1>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Card className="border-t-4 border-t-[#003A70]">
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <Phone className="h-5 w-5 text-[#003A70]" />
              ...
              <CardContent className="space-y-4">
                <div className="flex justify-between items-center border-b pb-2">
                  ...
                  <span className="font-bold text-[#003A70] bg-blue-50 px-3 py-1 rounded">1905</span>
                </div>
                <div className="flex justify-between items-center border-b pb-2">
                  <span className="font-medium text-gray-700">Police Assistance</span>
                  <span className="font-bold text-[#003A70] bg-blue-50 px-3 py-1 rounded">112 / 100</span>
                </div>
                <div className="flex justify-between items-center border-b pb-2">
                  <span className="font-medium text-gray-700">Fire & Ambulance</span>
                  <span className="font-bold text-[#003A70] bg-blue-50 px-3 py-1 rounded">108 / 112 / 101</span>
                </div>
                <div className="flex justify-between items-center border-b pb-2">
                  <span className="font-medium text-gray-700">Women Helpline</span>
                  <span className="font-bold text-[#003A70] bg-blue-50 px-3 py-1 rounded">1090</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="font-medium text-gray-700">Disaster Management</span>
                  <span className="font-bold text-[#003A70] bg-blue-50 px-3 py-1 rounded">1070</span>
                </div>
              </CardContent>
            </Card>
            ...
            <div className="space-y-6">
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center gap-2 text-lg">
                    <MapPin className="h-5 w-5 text-[#003A70]" />
                    Head Office
                  </CardTitle>
                </CardHeader>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center gap-2 text-lg">
                    <Mail className="h-5 w-5 text-[#003A70]" />
                    Email Support
                  </CardTitle>
                </CardHeader>
